...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/erp/employee/">人才购房申请管理</a></li>
		<li class="active"><a href="${ctx}/erp/employee/buyform?id=${employee.id}">人才购房信息<shiro:hasPermission name="erp:employee:edit">${not empty employee.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="erp:employee:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="employee" action="${ctx}/erp/employee/passbuyApply" method="post" class="form-horizontal">
		<form:hidden path="id"/>
