...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/oaNotify/">人事专员信息列表</a></li>
		<li class="active"><a href="${ctx}/oa/oaNotify/form?id=${hr_users.id}">人事<shiro:hasPermission name="oa:oaNotify:edit">${oaNotify.status eq '1' ? '查看' : not empty oaNotify.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hr_users" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
