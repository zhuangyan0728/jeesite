...
<%@ attribute name="selectParam" type="java.lang.String" required="false" description="url查询参数"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		// 正常打开	
		top.$.jBox.open("iframe:${ctx}/tag/treeselect?url="+encodeURIComponent("${url}&param="+$("#${selectParam}").val())+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&param="+$("#${selectParam}").val(), "选择${title}", 300, 420, {
